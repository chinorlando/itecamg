...
$(document).ready(function(){
	...
	table = $('.table').DataTable({ 
	    ...
	    "ajax": {
	        ...
	        'url': CFG.url+"admin/list_de_alumnos_a_programar",
	        "type": "POST"
	    },
...
// function programar_alumno_antiguo(id_alumno) {
// 	// alumno/materias_a_programar
// 	// var id = $('#id_persona').val();
// 	// alert('aqui estoy'+id);
// 	// $('#modal_confirmar').modal('hide');
// 	$.ajax({
// 		url: CFG.url+"alumno/materias_a_programar",
// 		type: 'POST',
// 		dataType: 'JSON',
...
function confirmar_matriculacion(id){
	// alert (id);
	$('#id_alumno').val(id);
...
function guardar_matriculacion() {
	// alert(id_alumno);
	var id_alumno = $('#id_alumno').val();
	alert('aqui estoy'+id_alumno);
	$('#modal_confirmar').modal('hide');
	$.ajax({
		url: CFG.url+"admin/confirmar_matriculacion",
		type: 'POST',
		dataType: 'JSON',
		data: {id_alumno: id_alumno},
	})
